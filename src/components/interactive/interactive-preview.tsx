 ...
 * customer taps them on their own device). Only the placeholder/fallback
 * labels are translated (namespace `Interactive.preview`); everything else
 * comes from the payload, so it can be dropped into the composer, the
 * automation builder, and the quick-replies manager as-is.
 */
