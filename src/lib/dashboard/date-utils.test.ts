...
describe("mondayIndex", () => {
  // Dates are built with the numeric constructor (local midnight) rather
  // than `new Date("2026-05-18")`, which the spec parses as UTC midnight —
  // that shifts to the previous day in any negative-offset timezone and
  // made these assertions fail outside UTC. mondayIndex reads getDay(),
  // which is local, so the fixtures must be local too.
