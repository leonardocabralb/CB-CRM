...
// Icon per notification type. `Record<Notification["type"], …>` is exhaustive
// on purpose: widening `NotificationType` without adding an icon here is a
// typecheck error, not a blank space in the list.
