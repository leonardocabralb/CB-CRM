...
| **M6** | `custom-fields-manager.tsx:155` | `fetchFields` liga `loading` e refaz as DUAS consultas depois de TODAS as 8 escritas — inclusive renomear um campo. Desmonta a lista e zera a rolagem | ✅ PR #103 — **medido**: renomear um campo levava a rolagem de 139 a 0, porque o spinner substitui o conteúdo e o `scrollHeight` desaba de 1215 para 84, fazendo o navegador grampear o `scrollTop`. Valia para as OITO escritas. O spinner virou opcional e só a montagem o pede; depois: 139 → 139, gravação confirmada no banco |
