...
- ⚠️ **A rota da META tem a mesma escada e a mesma espera desde 23/09/2026**
  ...
  - os recibos de um POST rodam **depois das mensagens** dele, para a espera
    ...
    **um de cada vez** (o espelho de `broadcast_recipients` lê e depois
    grava). Um recibo que espera segura os seguintes do mesmo POST — medido
    em 23/09, a Meta mandou UM recibo por POST nas 24 h.
